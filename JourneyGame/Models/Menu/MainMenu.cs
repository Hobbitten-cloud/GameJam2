...
public class MainMenu
{
    ...
    private CharacterCreationMenu _characterCreationMenu;
    ...
    public void StartMenu()
    {
        ...
        while (StartMenuLoop == true)
        {
            ...
            if (PlayerInput == 1)
            {
                ...
                _characterCreationMenu.ShowCharacterCreationMenu();
            }
    ...
    //    }
    //}
    public MainMenu(CharacterCreationMenu characterCreationMenu)
    {
